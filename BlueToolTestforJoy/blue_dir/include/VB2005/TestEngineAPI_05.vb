...
Module TestEngine
    ...
    End Function
    <DllImport("TestEngine.dll", EntryPoint:="openTestEngineSpiUnlock", _
    CharSet:=CharSet.Ansi, CallingConvention:=CallingConvention.StdCall)> _
    Function openTestEngineSpiUnlock (ByVal port As Integer, ByVal multi As Integer, ByVal transport As Integer, ByVal unlockKey As String) As UInteger
    End Function
    ...
    End Function
    <DllImport("TestEngine.dll", EntryPoint:="openTestEngineSpiUnlockTrans", _
    CharSet:=CharSet.Ansi, CallingConvention:=CallingConvention.StdCall)> _
    Function openTestEngineSpiUnlockTrans (ByVal trans As String, ByVal multi As Integer, ByVal unlockKey As String) As UInteger
    End Function
